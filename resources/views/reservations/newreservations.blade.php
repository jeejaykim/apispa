<table class="table table-hover">
    <thead class="text-primary">
        <tr>
            ...
            <th>Active</th>
            <th>
                <a href="{{ route('dashboard.today') }}" class="btn btn-primary" style="float:right; margin-left:5px;">Add New Reservation</a>
            </th>
        </tr>
    </thead>
    <tbody>    
        ...
        <tr>
            ...
            <td>
                ...
                <form action="{{ route('reservation.activate', ['reservation' => $reservation->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <button class="btn btn-primary" style="float:right; margin-left:5px;" type="submit">Activate </button>
                </form>
            </td>
        </tr>
        @endforeach
